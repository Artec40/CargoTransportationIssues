...
const Navbar = ({
                    getIssuesByFilter, companies, carriers, ATICodes, setCompanyFilter,
                    companyFilter, setCarrierFilter, carrierFilter, setATICodeFilter,
                    ATICodeFilter, setRequiredIssue, requiredIssue, getIssuesBySearch
                }) => {
